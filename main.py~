...
cv2.imwrite('zz_lines_img.jpg',img)
cv2.waitKey(0)
...
cv2.imshow('img',img)
cv2.imwrite('zz_words_img.jpg',img)
cv2.waitKey(0)
cv2.destroyAllWindows()
'''
...
# Finally show the image
cv2.imshow('img',img)
cv2.imwrite('zz_words_refine_img.jpg',img)
cv2.waitKey(0)
cv2.destroyAllWindows()
'''
...
# Finally show the image
cv2.imshow('img',img)
cv2.imwrite('zz1_word_split_img.jpg',img)
cv2.waitKey(0)
cv2.destroyAllWindows()
'''
...
# Finally show the image
cv2.imshow('img',img)
cv2.imwrite('zz1_word_splitLower_img.jpg',img)
...
# Finally show the image
cv2.imshow('img',img)
cv2.imwrite('zz1_word_split_region_img.jpg',img)
#cv2.imwrite('testResult.jpg',img)
cv2.waitKey(0)
cv2.destroyAllWindows()
'''
...
#******************************Character Segmentation Early Version********************************************************************

List_Char_Details_Unrefined = extractChars.ExtractChars(img, thresh_No_DE, List_Word_Split_Region)
#List_Char_Details_Unrefined = extractChars.ExtractChars(img, thresh_No_DE, List_Word_Details, pixel_Limit_Char_Extraction, header_Line_Percent)
...
# Finally show the image
cv2.imshow('img',img)
cv2.imwrite('zz1_chars_img.jpg',img)
...
#List_Char_Details = extractBoundaryRefine.refineChar(img, thresh_No_DE, List_Char_Details_Unrefined)
